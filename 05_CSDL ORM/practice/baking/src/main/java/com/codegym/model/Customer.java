...
public class Customer extends BaseEntities{
    ...
    public Customer(Long id, String fullName, String email, String phone, String address, BigDecimal balance, Set<Deposit> deposits, Set<Withdraw> withdraws, Set<Transfer> sender, Set<Transfer> recipient) {
        this.id = id;
        this.fullName = fullName;
        this.email = email;
        this.phone = phone;
